...
networkd: networkd.c parse.c parse.h util.c util.h validate.c validate.h service_exec.c service_exec.h service_write.c service_write.h ifstate.c ifstate.h
	$(CC) $(CFLAGS) -o $@ networkd.c parse.c util.c validate.c service_exec.c service_write.c ifstate.c -lutil
